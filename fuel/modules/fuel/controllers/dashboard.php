...
class Dashboard extends Fuel_base_controller {
	...
	function index()
	{
		...
		else
		{
			...
			//aa
			$vars['recentcust'] = $this->users_model->recentcust();
			$vars['recentinward'] = $this->users_model->recentinward();
			$vars['recentbilldes'] = $this->users_model->recentbilldes();
			$vars['recenttax'] = $this->users_model->recenttax();
			$vars['recentwip'] = $this->users_model->recentwip();
			$vars['recentvend'] = $this->users_model->recentvend();
