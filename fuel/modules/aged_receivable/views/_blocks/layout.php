...
<div id="main_content" style="overflow:hidden;">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div id="party_list">
        <div id="contentsholder" class="flexcroll"
...
<script language="javascript" type="text/javascript">
    ...
    function totalweight_check() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo fuel_url('aged_receivable/totalweight_check');?>/",
            data: dataString,
            datatype: "json",
...
<script type="text/javascript">
    function loadfolderlist(account, accname) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo fuel_url('aged_receivable/list_party');?>",
            ...
            if (msg.length == 0) {
                ...
                for (var i = 0; i < msg.length; i++) {
                    ...
                    thisdata["Phone"] = item.phone;
                    thisdata["Totalamount"] = item.totalamount;
                    thisdata["Amountpaid"] = item.amountpaid;
                    thisdata["Balanceamount"] = item.balanceamount;
                    totalweight_check();
    ...
    function functionpdf() {
        ...
        $.ajax({
            ...
            success: function (msg) {
                $("#check_bar").html('');
                var dataString = 'partyname=' + party_account_name + '&frmdate=' + selector + '&todate=' + selector1;
                var url = "<?php echo fuel_url('aged_receivable/billing_pdf');?>/?" + dataString;
                window.open(url);
            }
        });
    }
