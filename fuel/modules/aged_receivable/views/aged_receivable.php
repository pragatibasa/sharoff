...
$.post('<?php echo fuel_url("aged_receivable/list_coil"); ?>',
...
<div id="main_top_panel">
	<h2 class=" ico ico_reports">AGED RECEIVABLE</h2>
</div>

<?php include_once(AGED_RECEIVABLE_PATH.'views/_blocks/toolbar.php');?>		
<?php include_once(AGED_RECEIVABLE_PATH.'views/_blocks/layout.php');?>		
