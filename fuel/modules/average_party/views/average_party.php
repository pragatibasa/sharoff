...
$.post('<?php echo fuel_url("average_party/list_coil"); ?>',
...
<div id="main_top_panel">
	<h2 class=" ico ico_average_party">Average Partywise Holding </h2>
</div>

<?php include_once(AVERAGE_PARTY_PATH.'views/_blocks/toolbar.php');?>		
<?php include_once(AVERAGE_PARTY_PATH.'views/_blocks/layout.php');?>		
