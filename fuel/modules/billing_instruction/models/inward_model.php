...
<tr><td></td></tr>
	...
	function saveinwardentry($pid,$pname, $date3,$lno,$icno,$date4,$coil,$fWidth, 
							$fThickness,$fLength,$fQuantity,$status,$hno,$pna,$ppartyId,$parentBundleNumber)
	{
		$updateSql = '';
		if(!empty($ppartyId)) {
			$ppartyId = $ppartyId;
			$updateSql = "update aspen_tblinwardentry set fpresent = ( fpresent - $fQuantity )  where nPartyId ='". $pid. "'";
		...
		vHeatnumber,vPlantname,fpresent,billedweight,dSysDate,vprocess,vParentIRNumber,vParentBundleNumber) 
