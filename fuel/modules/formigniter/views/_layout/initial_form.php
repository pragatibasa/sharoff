...
{
?>
<a href="<?php echo site_url('formigniter')."/index/{$count}"; //echo base_url()."formigniter/{$count}"; ?>/" 
...
<?php echo form_open( "$field_total" ) ?>
...
<h3>Fill out the fields you want in your form, with field types, database type, and your validation rules and will output the code for the MVC + a database schema.</h3>
