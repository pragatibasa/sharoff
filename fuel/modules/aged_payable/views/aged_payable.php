...
$.post('<?php echo fuel_url("aged_payable/list_coil"); ?>',
...
<div id="main_top_panel">
	<h2 class=" ico ico_reports">AGED PAYABLE</h2>
</div>

<?php include_once(AGED_PAYABLE_PATH.'views/_blocks/toolbar.php');?>		
<?php include_once(AGED_PAYABLE_PATH.'views/_blocks/layout.php');?>		
