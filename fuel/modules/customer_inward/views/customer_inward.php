...
$.post('<?php echo fuel_url("customer_inward/list_coil"); ?>',
...
<div id="main_top_panel">
	<h2 class=" ico ico_customer_inward"> Customer Inward</h2>
</div>

<?php include_once(CUSTOMER_INWARD_PATH.'views/_blocks/toolbar.php');?>		
<?php include_once(CUSTOMER_INWARD_PATH.'views/_blocks/layout.php');?>		
